...
existing_events = [
                      ...
                      Event("Gym Membership", datetime(2024, 3, 5), recurrent_type="monthly", days=[5]),
...
if __name__ == "__main__":
    ...
    for event in get_events_in_range(start_date=datetime(2025, 2, 1), end_date=datetime(2024, 3, 28), event_list=existing_events):
        print(f"{event.id}|{event.name} - {event.recurrent_type} - {event.interval} - {event.days}")
